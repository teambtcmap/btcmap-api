            ...
            .service(
                service("rpc").guard(actix_web::guard::Post()).finish(
                    jsonrpc_v2::Server::new()
                        ...
                        .with_method("add_allowed_action", rpc::add_allowed_action::run)
                        .with_method("removeallowedaction", rpc::remove_allowed_action::run)
                        .with_method("remove_allowed_action", rpc::remove_allowed_action::run)
                        ...
                        .with_method("get_boosts", rpc::get_boosts::run)
                        .finish()
