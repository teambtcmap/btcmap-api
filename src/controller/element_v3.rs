...
mod tests {
    ...
    async fn get_with_limit() -> Result<()> {
        ...
        conn.execute(
            "INSERT INTO element (id, updated_at) VALUES ('node:1', '2023-05-05')",
            [],
        )?;
        conn.execute(
            "INSERT INTO element (id, updated_at) VALUES ('node:2', '2023-05-06')",
            [],
        )?;
        conn.execute(
            "INSERT INTO element (id, updated_at) VALUES ('node:3', '2023-05-07')",
            [],
        )?;
