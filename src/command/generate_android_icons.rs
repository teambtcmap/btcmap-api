...
pub async fn run(db: Connection) -> Result<()> {
    ...
    for element in elements {
        ...
        let new_icon = android_icon(&element.osm_json["tags"].as_object().unwrap());
...
pub fn android_icon(tags: &Map<String, Value>) -> String {
    let amenity = tags
        .get("amenity")
    ...
    let healthcare = tags
        ...
        .as_str()
        .unwrap_or("");
    let healthcare_speciality = tags
