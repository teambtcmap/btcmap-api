...
- [dashboard](dashboard.md): Get a high-level analytics snapshot (place activity, imports by origin, log stats incl. unique IPs per platform, disk usage, LND balances, recent sync runs over 1/7/30 day windows, and BTC Map wallet balances).
